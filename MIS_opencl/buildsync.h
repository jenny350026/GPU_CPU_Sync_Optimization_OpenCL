...
#g++ -c debug_helpers.cpp
g++ -c debug_helpers.cpp  -o MIS_sync2.o -I ./ -I$AMDAPPSDKROOT/include 
...
g++ -o MIS_sync MIS_sync.o  MIS_sync2.o -lOpenCL -L$AMDAPPSDKROOT/lib/x86_64
